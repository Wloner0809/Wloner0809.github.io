...
<li>
<div class="pub-row">
  {% if link.image and link.conference_short %}
    ...
    <div class="links">
      ...
      <script>
        $(document).ready(function () {
            var gsDataBaseUrl = 'https://raw.githubusercontent.com/Wloner0809/wloner0809.github.io/';
